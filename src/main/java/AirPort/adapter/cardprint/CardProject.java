 ...
 *
 * <p>앞/뒤 면({@code cardData.front/back}) 각각 배경 이미지 + 사진 영역 + 텍스트 요소를 담는다. 텍스트는 {@code "{컬럼명}"} 바인딩(예
 * {@code {이름}})을 쓰며 인쇄 시 실제 값으로 치환한다. 좌표는 디자인 캔버스 좌표계라 배경 해상도로 스케일해 렌더한다. qr/barcode/imageElements
 * 등 미사용 필드는 무시한다.
 */
