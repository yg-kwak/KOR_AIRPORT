/* ============================================================================
   ...
   담는 내용
     ...
     [6] 감사유형(AT) — 시스템 사건 코드 제거(유형 목록에서 숨김)
   ============================================================================ */
SET NOCOUNT ON;
...
/* ────────────────────────────────────────────────────────────────────────────
   [6] 감사유형(AT) — 시스템 사건 코드 제거
   기동·종료·자동 파기는 감사추적의 메뉴 [시스템] 으로 골라 본다.
   유형 목록에도 넣으면 같은 것을 고르는 곳이 두 군데가 되어 헷갈린다.
   기록 자체는 그대로 두고 코드만 지운다 — 유형 칸의 이름은 프로그램이 붙인다.
   (이 스크립트를 앞서 실행해 코드가 들어갔다면 여기서 정리된다)
   ──────────────────────────────────────────────────────────────────────────── */
