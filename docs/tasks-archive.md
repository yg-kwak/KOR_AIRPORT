...
- [x] 현장 적용 준비 — 파일 로그 활성(LOG_PATH 로 경로 지정, 일자+50MB 분할·30일·1GB 보관: 서비스 등록 시 콘솔 로그 소실 방지), 신규 설치용 sql/install.sql, 기존 DB 갱신용 sql/migration/2026-07-30_visit-checkout.sql(멱등) — sjpark2, 2026-07-30
