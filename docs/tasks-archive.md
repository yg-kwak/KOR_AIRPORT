...
- [x] 기관차량등록(/company/car) — 기관관리(700) 하위 702. 기관 소속 차량(tb_car + company_code)과 차량용 카드(tb_card + car_id) 발급/회수. 카드구분은 서버가 차량 고정·패스구분 미사용, 카드 있는 차량은 삭제 거부, 회수는 car_id=NULL(재사용). 곁들여 잘못된 JSON 본문이 500 → 400 이 되도록 GlobalExceptionHandler 보강 — sjpark2, 2026-07-22
